...
def main():
    ...
    for img_path in img_paths:
        ...
        if args.full_frame and len(all_verts) > 0:
            ...
            # scaled_focal_length = 12500 # default from demo_depth
            ...
            # Save as PLY
            o3d.io.write_point_cloud(os.path.join(args.out_folder, f'{img_fn}_fetch_cam.ply'), pcd)
            print("Vertices saved to 'vertices.ply' using Open3D.")
