...
from trial_data_recorder import TrialDataRecorder
...
if __name__ == "__main__":
    ...
    trial_recorder = TrialDataRecorder(motionplanner)
   ...
   # Add standoff pose
    ...
    # Save initial data: trajectory + base pose
    trial_recorder.save_initial_data(aligned_trajectory, RT_base_b4_opt)
    ...
    if IS_BASE:
        ...
        trial_recorder.start_recording(phase="base_move")
        if not (x_delta < 0):
            ...
            rospy.sleep(3)
        trial_recorder.pause_recording()
    ...
    trial_recorder.start_recording(phase="arm_execute")
    ...
    # Record final datapoint after gripper opens, then stop and save HDF5
    trial_recorder.record_single_datapoint(phase="arm_execute")
    trial_recorder.stop_recording()
    h5_filename = f"{data_save_folder_name}/trial_data.h5"
    trial_recorder.save_to_hdf5(h5_filename, trajectory_name=task_name, language_instruction=f"task_{TASK_ID}")
